...
import { Building2, Factory, Globe, Loader2, Search, MessageSquare, Users } from 'lucide-react';
...
const ResearchForm = ({
  ...
  const tones: ToneType[] = ['Objective', 'Formal', 'Analytical', 'Persuasive', 'Informal', 'Critical'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative group md:col-span-2">
              <label
                ...
                className="block text-base font-medium text-gray-700 mb-2.5 transition-all duration-200 group-hover:text-gray-900 font-['DM_Sans']"
              >
                Competitors <span className="text-gray-400 font-normal">(Optional, comma-separated)</span>
              </label>
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-gray-50/0 via-gray-100/50 to-gray-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
            ...
            <div className="relative group md:col-span-2">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-gray-50/0 via-gray-100/50 to-gray-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
                <MessageSquare className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 stroke-[#468BFF] transition-all duration-200 group-hover:stroke-[#8FBCFA] z-10" strokeWidth={1.5} />
                <select
                  id="tone"
                  value={formData.tone}
                  onChange={(e) =>
                  ...
                  className={`${glassStyle.input} transition-all duration-300 focus:border-[#468BFF]/50 focus:ring-1 focus:ring-[#468BFF]/50 group-hover:border-[#468BFF]/30 bg-white/80 backdrop-blur-sm text-lg py-4 pl-12 pr-10 font-['DM_Sans'] appearance-none cursor-pointer`}
                >
                  {tones.map((tone) => (
