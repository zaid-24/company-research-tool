...
import { Check, Copy, Download, Loader2, FileText } from 'lucide-react';
        ...
        {output?.details?.report && (
          <>
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-[#8B5CF6] text-white hover:bg-[#A78BFA] transition-all duration-200"
